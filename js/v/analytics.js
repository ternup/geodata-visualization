...
$(function () {
	...
	function createTimeLine(times, color){
	...
	for(var i=0;i<times.length;i++){
		data.push(times[i].toString());
		labels.push(times[i].toString());
	}
    ...
    // Draw
		...
		color = color == 'green' ? 'rgb(0,127,14)' : color == 'red' ? 'rgb(255,0, 0)' : color == 'blue' ? 'rgb(0, 0, 255)' : color == 'orange' ? 'rgb(255,122, 50)' : 'rgb(0,127,14)';
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[0].attr({text: data + " time" + (data == 1 ? "" : "s")}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
